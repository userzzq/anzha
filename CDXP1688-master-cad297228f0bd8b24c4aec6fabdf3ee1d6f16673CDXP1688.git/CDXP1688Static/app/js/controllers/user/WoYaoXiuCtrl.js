(function() {
  ...
  ctrls.controller('WoYaoXiuCtrl', ['$scope', '$log', '$timeout', 'UtilsService', 'MyDataService', 'DialogService', WoYaoXiuCtrl]);

  function WoYaoXiuCtrl($scope, $log, $timeout, UtilsService, MyDataService, DialogService) {
    $log.debug('WoYaoXiuCtrl init...');

    // 处理scope销毁
    $scope.$on('$destroy', function() {
      $log.debug('WoYaoXiuCtrl destroy...');
    });
