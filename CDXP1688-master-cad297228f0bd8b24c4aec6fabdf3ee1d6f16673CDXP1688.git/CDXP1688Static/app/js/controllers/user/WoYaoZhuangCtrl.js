(function() {
  ...
  ctrls.controller('WoYaoZhuangCtrl', ['$scope', '$log', '$timeout', 'UtilsService', 'MyDataService', 'DialogService', WoYaoZhuangCtrl]);

  function WoYaoZhuangCtrl($scope, $log, $timeout, UtilsService, MyDataService, DialogService) {
    $log.debug('WoYaoZhuangCtrl init...');

    // 处理scope销毁
    $scope.$on('$destroy', function() {
      $log.debug('WoYaoZhuangCtrl destroy...');
    });
