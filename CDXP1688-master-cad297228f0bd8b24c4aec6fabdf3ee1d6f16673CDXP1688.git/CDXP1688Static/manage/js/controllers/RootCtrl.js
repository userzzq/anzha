(function () {
  ...
  ctrls.controller('RootCtrl', ['$rootScope', '$scope', '$log', '$location', 'UtilsService', RootCtrl]);

  function RootCtrl($rootScope, $scope, $log, $location, UtilsService) {
